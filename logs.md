...
- Ruiqiao Jiang
  ...
  - Wrotd the tutorial meeting minutes.(0.5h)
...
| 7         | 5        | The lesson I learnt is that since we are not very familiar with the database developemnt, the time we spent on learning may be huge. And for example, we studied the C# for the management system, but I just found that the Django may be more suitable for our development.                                                                                                                                                                                           | Ruiqiao Jiang |
